                                    ...
                                    <div className="blog-post-details">
                                                ...
                                                <div className="row g-4">
                                                    <div className="col-lg-6">
                                                        <div className="details-image">
                                                            <img loading="lazy" src="/assets/img/news/post-5.jpg" alt="img" />
                                                        </div>
                                                    </div>
                                                    <div className="col-lg-6">
                                                        <div className="details-image">
                                                            <img loading="lazy" src="/assets/img/news/post-6.jpg" alt="img" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <p className="pt-5">
                                        ...
                                        <div className="comments-area">
                                            ...
                                            <div className="blog-single-comment d-flex gap-4 pt-4 pb-5">
                                                <div className="image">
                                                    <img loading="lazy" src="/assets/img/news/comment.png" alt="image" />
                                                </div>
                                            ...
                                            <div className="blog-single-comment d-flex gap-4 pt-5 pb-5">
                                                <div className="image">
                                                    <img loading="lazy" src="/assets/img/news/comment-2.png" alt="image" />
                                                </div>
                                                <div className="content">
                                                    <div className="head d-flex flex-wrap gap-2 align-items-center justify-content-between">
                                                        <div className="con">
                                                ...
                                                <div className="row g-4">
                                                    ...
                                                    <div className="col-lg-6">
                                                        <button type="submit" className="theme-btn ">
                                                            post comment<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" height={'17px'} width={"17px"} ><path d="M429.8 273l17-17-17-17L276.2 85.4l-17-17-33.9 33.9 17 17L354.9 232 24 232 0 232l0 48 24 0 330.8 0L242.2 392.6l-17 17 33.9 33.9 17-17L429.8 273z"/></svg>
                                                        </button>
                                                    </div>
                                                </div>
                                            </form>
