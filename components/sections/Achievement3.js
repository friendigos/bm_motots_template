        ...
        <>
            <section className="achievement-section-3 fix section-bg-2">
                <div className="shape-image">
                    <img loading="lazy" src="/assets/img/achiv-shape.png" alt="shape-img" />
                </div>
                    ...
                    <div className="achievement-wrapper style-2">
                        ...
                        <div className="counter-area">
                            <div className="counter-items wow fadeInUp" data-wow-delay=".3s">
                                <div className="icon">
                                    <img loading="lazy" src="/assets/img/achievement-icon/01.svg" alt="icon-img" />
                                </div>
                            ...
                            <div className="counter-items wow fadeInUp" data-wow-delay=".5s">
                                <div className="icon">
                                    <img loading="lazy" src="/assets/img/achievement-icon/02.svg" alt="icon-img" />
                                </div>
                                <div className="content">
                            ...
                            <div className="counter-items wow fadeInUp" data-wow-delay=".7s">
                                <div className="icon">
                                    <img loading="lazy" src="/assets/img/achievement-icon/03.svg" alt="icon-img" />
                                </div>
                                <div className="content">
                            ...
                            <div className="counter-items wow fadeInUp" data-wow-delay=".9s">
                                <div className="icon">
                                    <img loading="lazy" src="/assets/img/achievement-icon/04.svg" alt="icon-img" />
                                </div>
                                <div className="content">
