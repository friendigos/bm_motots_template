...
const Getinto = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const serviceId = "service_8erar0i";
        const templateId = "template_7hbx9sb";
        const publicKey = "tACetUc2cQu9_vf9a";

        const template_Paramas = {
            from_name: name,
            from_number: number,
            to_name: "B M Motors Pvt Ltd",
            message: message,
        };
        emailjs
            .send(serviceId, templateId, template_Paramas, publicKey)
            .then((response) => {
                            ...
                            <div className="row g-4 align-items-center">
                                        ...
                                        <div className="contact-info-area-2">
                                            ...
                                            <div className="contact-info-items border-none">
                                                ...
                                                <div className="content">
                                                    <p>Office Location </p>
                                                    <h3>
                                                        Gat No.1079, A/P-Kadamwakwasti, Pune-Solapur
                                                        Highway, Tal.Haveli, Dist.-Pune
                                                    </h3>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="col-lg-6">
                                    <div className="contact-content">
                                        ...
                                        <p>
                                            Get rid of your old vehicles with ease! Our efficient
                                            scrapping solutions ensure a quick, reliable, and
                                            hassle-free experience, tailored to meet your needs.
                                        </p>
                                        <form
                                            action="contact.php"
                                            id="contact-form"
