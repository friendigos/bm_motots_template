            ...
            <div className="swiper project-slider-3">
                <Swiper {...swiperOptions} className="swiper-wrapper">
                    <SwiperSlide>
                        <div className="project-items style-2">
                            <div className="project-image">
                                <img loading="lazy" src="/assets/img/project/08.jpg" alt="project-img" />
                    ...
                    <SwiperSlide>
                        <div className="project-items style-2">
                            <div className="project-image">
                                <img loading="lazy" src="/assets/img/project/09.jpg" alt="project-img" />
                                <div className="project-content">
                                    <p>Solutions</p>
                                    <h4>
                    ...
                    <SwiperSlide>
                        <div className="project-items style-2">
                            <div className="project-image">
                                <img loading="lazy" src="/assets/img/project/10.jpg" alt="project-img" />
                                <div className="project-content">
                                    <p>Technology</p>
                                    <h4>
                    ...
                    <SwiperSlide>
                        <div className="project-items style-2">
                            <div className="project-image">
                                <img loading="lazy" src="/assets/img/project/11.jpg" alt="project-img" />
                                <div className="project-content">
                                    <p>Technology</p>
                                    <h4>
                                        <Link href="/project-details">Software Development</Link>
